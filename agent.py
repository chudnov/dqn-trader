...
class DQNAgent(object):
    ...
    def replay(self):
        ...
        states = np.concatenate(minibatch[:, 0]).reshape(self.batch_size, self.env.observation_space[1])
        ...
        next_states = np.concatenate(minibatch[:, 3]).reshape(self.batch_size, self.env.observation_space[1])
